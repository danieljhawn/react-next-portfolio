            ...
            <div className="row">
              ...
              <div className="col">
                <p className="bodyText">
                  In 2019 I moved to Austin and entered the UT Full Stack Coding
                  Bootcamp. This page is a collection of some of the projects
                  I've worked on in that time. You can find these projects in
                  the{" "}
